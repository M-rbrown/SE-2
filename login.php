...
define('LOCKOUT_TIME', 60); // Lockout time in seconds (5 minutes)
...
if (isset($_SESSION['lockout_time']) && time() < $_SESSION['lockout_time']) {
    ...
    $password = trim($_POST['pass']);  // Plain password entered by the admin
...
<body style="
  background-image: url('images/windows.jpg'); /* Adjust the path if necessary */
